...
phpcs --report=full --warning-severity=0 --standard=~/.composer/vendor/drupal/coder/coder_sniffer/DrupalPractice "$DRUPAL_TI_DRUPAL_DIR/modules/$DRUPAL_TI_MODULE_NAME" || false
